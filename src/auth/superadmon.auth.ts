...
export const SuperAdminAut = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        if(decoded.role != "superadmon") throw new ResponseError(401, "No tienes permisos");
