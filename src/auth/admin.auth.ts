...
export const AdminAut = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        if(decoded.role != "superadmon" && decoded.role !== "admin") throw new ResponseError(401, "No tienes permisos");
